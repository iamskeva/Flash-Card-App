...
def next_card():
    ...
    canvas.itemconfig(front_card_img, image=card_front_png)
...
def flip_card():
    canvas.itemconfig(front_card_img, image=card_back_png)
...
front_card_img = canvas.create_image(400, 263, image=card_front_png)
